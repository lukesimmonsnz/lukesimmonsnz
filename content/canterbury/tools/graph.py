...
from ``content/canterbury/data/``, validates each entity against its schema,
...
Run as a script to dump a summary of the loaded graph::
    ...
    python content/canterbury/tools/graph.py
"""
...
def load_graph(root: Path | str | None = None,
    ...
    if schema_root is None:
        # Derive: content/canterbury/ → content/ → content/_schema/
