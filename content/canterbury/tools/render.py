"""Render a Problem entity to a Markdown page under content/canterbury/pages/.

Usage:

    python content/canterbury/tools/render.py problem.canterbury.housing.affordability
    python content/canterbury/tools/render.py --all
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "problem_id", nargs="?",
        help="Fully qualified Problem id (e.g. problem.canterbury.housing.affordability)"
    )
