---
title: "Active transport and walkability deficit"
section: transport
subpage: active_transport
order: 4
updated: 2026-04-26
summary: >
  Low cycling and walking mode share reflects inadequate infrastructure investment.
status: draft
generated_from: problem.waikato.transport.active_transport
---
...
- **Low cycling and walking mode share in Waikato reflects inadequate infrastructure investment and sprawling development patterns. Protected cycleways are limited to Hamilton CBD; rural communities lack safe networks; investment in cycling infrastructure could increase mode share from 5% to 12-15%.** *(confidence: medium)* — Waikato Regional Council Annual Plan 2024.
...
- `Addressing active transport creates feedback on regional outcomes.`


---

*Generated from `problem.waikato.transport.active_transport` on 2026-04-26. Do not hand-edit. Edit the entity files under the region's `data/` directory and re-run the region's render.py.*
